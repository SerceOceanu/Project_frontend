  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col lg:flex-row bg-transparent relative z-10 p-10 items-center gap-5  md:gap-[50px]'>
        <Image src="/assets/images/no-favorites.svg" alt="image" 
          width={182} 
          height={218} 
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-[24px] text-base/6 font-semibold rubik text-center lg:text-left ">
            {t('profile.no-favorites')}
          </h2>
          <p className=" text-gray text-center lg:text-left">
            {t('profile.no-favorites-text')}
          </p>
          <Button  className="text-lg md:text-2xl self-center lg:self-start h-[44px] px-6">
            {t('profile.no-favorites-button')}
          </Button>
        </div>
      </div>
    </div>
