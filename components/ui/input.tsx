  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-orange focus-visible:ring-orange/50 focus-visible:ring-[2px]",
        "aria-invalid:border-orange/20 dark:aria-invalid:border-orange/40 aria-invalid:border-orange",
        className
      )}
      {...props}
    />
